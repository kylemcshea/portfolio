...
const greeting = {
  ...
  title: "Hi, I'm Kyle",
  subTitle: emoji(
    "A passionate Software Engineer 🚀 having experience with building Web/Mobile applications with Reactjs, data collection via Puppeteer, and cool libraries and frameworks for various projects."
  ),
  resumeLink:
